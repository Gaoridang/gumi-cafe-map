...
function App() {
  ...
  // Real seed data (Slice 1 foundation). Filtering is demo-only here; real filters come in next slice.
  const filtered = seedCafes.filter((c) =>
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900 font-sans">
      ...
      <div className="grid grid-cols-[440px_1fr_380px] h-[calc(100vh-4rem)] overflow-hidden">
        ...
        {/* Center: Live MapView (Slice 1) — bidirectional with list + inspector */}
        <MapView
          cafes={seedCafes}
